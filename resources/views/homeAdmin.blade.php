                        ...
                        <div class="col-sm-4 mb-5" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                ...
                                <div class="block-4-text p-4">
                                    ...
                                    <a href="/mgorder" role="button" class="btn btn-lg btn-primary"
                                        style="width: 80%;">View</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 mb-5" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                ...
                                <div class="block-4-text p-4">
                                    ...
                                    <a href="/mgcate" role="button" class="btn btn-lg btn-primary"
                                        style="width: 80%;">View</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4 mb-5" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                ...
                                <div class="block-4-text p-4">
                                    ...
                                    <a href="/mgbrand" role="button" class="btn btn-lg btn-primary"
                                        style="width: 80%;">View</a>
                                </div>
                            </div>
                        </div>
